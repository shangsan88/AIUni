export const settingsZhCN = {
  settings: {
    ...
    // TTS Voice descriptions (Gemini)
    geminiVoiceZephyr: '明亮',
    geminiVoicePuck: '活泼',
    geminiVoiceCharon: '知性',
    geminiVoiceKore: '沉稳',
    geminiVoiceFenrir: '兴奋',
    geminiVoiceLeda: '青春',
    geminiVoiceOrus: '沉稳',
    geminiVoiceAoede: '轻快',
    geminiVoiceCallirrhoe: '随和',
    geminiVoiceAutonoe: '明亮',
    geminiVoiceEnceladus: '气声',
    geminiVoiceIapetus: '清晰',
    geminiVoiceUmbriel: '随和',
    geminiVoiceAlgieba: '柔和',
    geminiVoiceDespina: '柔和',
    geminiVoiceErinome: '清晰',
    geminiVoiceAlgenib: '沙哑',
    geminiVoiceRasalgethi: '知性',
    geminiVoiceLaomedeia: '活泼',
    geminiVoiceAchernar: '轻柔',
    geminiVoiceAlnilam: '沉稳',
    geminiVoiceSchedar: '平稳',
    geminiVoiceGacrux: '成熟',
    geminiVoicePulcherrima: '前卫',
    geminiVoiceAchird: '友好',
    geminiVoiceZubenelgenubi: '休闲',
    geminiVoiceVindemiatrix: '温柔',
    geminiVoiceSadachbia: '活泼',
    geminiVoiceSadaltager: '博学',
    geminiVoiceSulafat: '温暖',
...
export const settingsEnUS = {
  settings: {
    ...
    // TTS Voice descriptions (Gemini)
    geminiVoiceZephyr: 'Bright',
    geminiVoicePuck: 'Upbeat',
    geminiVoiceCharon: 'Informative',
    geminiVoiceKore: 'Firm',
    geminiVoiceFenrir: 'Excitable',
    geminiVoiceLeda: 'Youthful',
    geminiVoiceOrus: 'Firm',
    geminiVoiceAoede: 'Breezy',
    geminiVoiceCallirrhoe: 'Easy-going',
    geminiVoiceAutonoe: 'Bright',
    geminiVoiceEnceladus: 'Breathy',
    geminiVoiceIapetus: 'Clear',
    geminiVoiceUmbriel: 'Easy-going',
    geminiVoiceAlgieba: 'Smooth',
    geminiVoiceDespina: 'Smooth',
    geminiVoiceErinome: 'Clear',
    geminiVoiceAlgenib: 'Gravelly',
    geminiVoiceRasalgethi: 'Informative',
    geminiVoiceLaomedeia: 'Upbeat',
    geminiVoiceAchernar: 'Soft',
    geminiVoiceAlnilam: 'Firm',
    geminiVoiceSchedar: 'Even',
    geminiVoiceGacrux: 'Mature',
    geminiVoicePulcherrima: 'Forward',
    geminiVoiceAchird: 'Friendly',
    geminiVoiceZubenelgenubi: 'Casual',
    geminiVoiceVindemiatrix: 'Gentle',
    geminiVoiceSadachbia: 'Lively',
    geminiVoiceSadaltager: 'Knowledgeable',
    geminiVoiceSulafat: 'Warm',
    // ASR Language names (native forms - autoglossonyms)
