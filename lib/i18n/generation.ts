...
export const generationRuRU = {
  ...
  generation: {
    ...
    imageTruncated: 'Найдено {total} изображений, это больше лимита {max}. Лишние будут переданы только как текстовые описания',
    ...
    outlineEmptyResponse: 'Модель не вернула валидную структуру. Проверь конфигурацию модели и попробуй снова',
